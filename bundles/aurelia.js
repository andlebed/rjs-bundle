...
define('aurelia-plugins-google-recaptcha/aurelia-plugins-google-recaptcha-config',['exports'], function (exports) {
  'use strict';
...
define('aurelia-plugins-google-recaptcha/aurelia-plugins-google-recaptcha',['exports', './aurelia-plugins-google-recaptcha-config'], function (exports, _aureliaPluginsGoogleRecaptchaConfig) {
  'use strict';
...
define('aurelia-plugins-google-recaptcha', ['aurelia-plugins-google-recaptcha/aurelia-plugins-google-recaptcha'], function (main) { return main; });
